...
es6: $(grammar_file)
	python replace_parser_content.py ./Sequence/_sequenceLexer.g4 ./typescript/common_lexer.g4 ./Sequence/sequenceLexer.g4 '<<<<<<common<<<<<<'
	python replace_parser_content.py ./Sequence/_sequenceParser.g4 ./typescript/common_parser.g4 ./Sequence/sequenceParser.g4 '<<<<<<common<<<<<<'
