...
es6: $(grammar_file)
	python replace_parser_content.py ./Flashcard/_flashcardLexer.g4 ./typescript/common_lexer.g4 ./Flashcard/flashcardLexer.g4 '<<<<<<common<<<<<<'
	python replace_parser_content.py ./Flashcard/_flashcardParser.g4 ./typescript/common_parser.g4 ./Flashcard/flashcardParser.g4 '<<<<<<common<<<<<<'
