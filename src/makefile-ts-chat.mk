...
es6: $(grammar_file)
	python replace_parser_content.py ./Chat/_chatLexer.g4 ./typescript/common_lexer.g4 ./Chat/chatLexer.g4 '<<<<<<common<<<<<<'
	python replace_parser_content.py ./Chat/_chatParser.g4 ./typescript/common_parser.g4 ./Chat/chatParser.g4 '<<<<<<common<<<<<<'
