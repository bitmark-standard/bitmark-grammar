...
// close
import { clozeLexer } from './typescript-es6/clozeLexer';
import { clozeParser } from './typescript-es6/clozeParser';
// match
import { matchLexer } from './typescript-es6/matchLexer';
import { matchParser } from './typescript-es6/matchParser';
// multiple-choice-*
import { choiceLexer } from './typescript-es6/choiceLexer';
import { choiceParser } from './typescript-es6/choiceParser';

import { interviewLexer } from './typescript-es6/interviewLexer';
import { interviewParser } from './typescript-es6/interviewParser';

import { truefalseLexer } from './typescript-es6/truefalseLexer';
import { truefalseParser } from './typescript-es6/truefalseParser';

import { flashcardLexer } from './typescript-es6/flashcardLexer';
import { flashcardParser } from './typescript-es6/flashcardParser';

import { chatLexer } from './typescript-es6/chatLexer';
import { chatParser } from './typescript-es6/chatParser';

import { sequenceLexer } from './typescript-es6/sequenceLexer';
import { sequenceParser } from './typescript-es6/sequenceParser';

import { BitmarkListener } from './bitmark-listener.mjs';  // TS!
...
class Preprocessor {
  ...
  */
  escape_json_for_json_bits(text: string)
  ...
  replace_stray_bitheads(text: string): string[] {
    let seq = 0;
    let ignore = 5;
...
class BitmarkErrorListener extends DefaultErrorStrategy {
  ...
  syntaxError(recognizer: Parser,
	  offendingSymbol: string, line: number, column: number, msg: string, e: Exception) {
