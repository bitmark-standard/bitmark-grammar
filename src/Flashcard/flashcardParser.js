...
flashcardParser.AmpAppLink = 116;
flashcardParser.AmpWebsiteLink = 117;
flashcardParser.AmpStillImageFilmLink = 118;
flashcardParser.OpAmpAudioLink = 119;
flashcardParser.OpAmpImageLink = 120;
flashcardParser.OpAmpVideoLink = 121;
flashcardParser.OpAmpArticleLink = 122;
flashcardParser.OpAmpDocumentLink = 123;
flashcardParser.OpAmpAppLink = 124;
flashcardParser.OpAmpWebsiteLink = 125;
flashcardParser.OpAmpStillImageFilmLink = 126;
flashcardParser.AmpImageEmbed = 127;
flashcardParser.AmpVideoEmbed = 128;
flashcardParser.AmpAudioEmbed = 129;
flashcardParser.AmpDocumentEmbed = 130;
flashcardParser.AmpStillImageFilmEmbed = 131;
flashcardParser.OpAmpImageEmbed = 132;
flashcardParser.OpAmpVideoEmbed = 133;
flashcardParser.OpAmpAudioEmbed = 134;
flashcardParser.OpAmpDocumentEmbed = 135;
flashcardParser.OpAmpStillImageFilmEmbed = 136;
flashcardParser.BitmarkMinus = 137;
flashcardParser.BitmarkPlus = 138;
flashcardParser.ColonText = 139;
flashcardParser.ColonJson = 140;
flashcardParser.Prosemirror = 141;
flashcardParser.Placeholder = 142;
flashcardParser.BASIC = 143;
flashcardParser.JPG = 144;
flashcardParser.PNG = 145;
flashcardParser.GIF = 146;
flashcardParser.SVG = 147;
flashcardParser.MP2 = 148;
flashcardParser.MP3 = 149;
flashcardParser.MP4 = 150;
flashcardParser.FLV = 151;
flashcardParser.WMV = 152;
flashcardParser.MPEG = 153;
flashcardParser.MPG = 154;
flashcardParser.TEL = 155;
flashcardParser.DotArticleAtt = 156;
flashcardParser.STAR = 157;
flashcardParser.URL = 158;
flashcardParser.LIST_LINE = 159;
flashcardParser.ENCLBARS = 160;
...
flashcardParser._serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03\xA2\u055E\x04" +
