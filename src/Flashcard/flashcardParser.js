    ...
    vocab() {
        ...
        try {
            ...
            this.enterOuterAlt(_localctx, 1);
            {
                ...
                this._errHandler.sync(this);
                _la = this._input.LA(1);
                while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << flashcardParser.S) | (1 << flashcardParser.OPRANGLES) | (1 << flashcardParser.OPRANGLEL) | (1 << flashcardParser.OPDANGLE) | (1 << flashcardParser.OPU) | (1 << flashcardParser.OPB) | (1 << flashcardParser.OPQ) | (1 << flashcardParser.OPA) | (1 << flashcardParser.OPS) | (1 << flashcardParser.OPC) | (1 << flashcardParser.OPHASH) | (1 << flashcardParser.COLON))) !== 0) || ((((_la - 32)) & ~0x1F) === 0 && ((1 << (_la - 32)) & ((1 << (flashcardParser.AMP - 32)) | (1 << (flashcardParser.Greater - 32)) | (1 << (flashcardParser.Less - 32)) | (1 << (flashcardParser.RightAngle - 32)) | (1 << (flashcardParser.RightArrow - 32)) | (1 << (flashcardParser.ArticleText - 32)) | (1 << (flashcardParser.NUMERIC - 32)) | (1 << (flashcardParser.STRING - 32)) | (1 << (flashcardParser.NOTBITMARK - 32)) | (1 << (flashcardParser.SENTENCE - 32)) | (1 << (flashcardParser.BARSTRING - 32)) | (1 << (flashcardParser.AtReference - 32)))) !== 0) || ((((_la - 65)) & ~0x1F) === 0 && ((1 << (_la - 65)) & ((1 << (flashcardParser.AtExampleWithStr - 65)) | (1 << (flashcardParser.AtExamplecol - 65)) | (1 << (flashcardParser.AtExamplecl - 65)) | (1 << (flashcardParser.AtLabeltrue - 65)) | (1 << (flashcardParser.AtLabelfalse - 65)) | (1 << (flashcardParser.OpAtCopyright - 65)))) !== 0) || ((((_la - 98)) & ~0x1F) === 0 && ((1 << (_la - 98)) & ((1 << (flashcardParser.OpAmpAudio - 98)) | (1 << (flashcardParser.OpAmpImage - 98)) | (1 << (flashcardParser.OpAmpImageZoom - 98)) | (1 << (flashcardParser.OpAmpImageWAudio - 98)) | (1 << (flashcardParser.OpAmpVideo - 98)) | (1 << (flashcardParser.OpAmpArticle - 98)) | (1 << (flashcardParser.OpAmpDocument - 98)) | (1 << (flashcardParser.OpAmpApp - 98)) | (1 << (flashcardParser.OpAmpWebsite - 98)) | (1 << (flashcardParser.OpAmpStillImageFilm - 98)) | (1 << (flashcardParser.OpAmpAudioLink - 98)) | (1 << (flashcardParser.OpAmpImageLink - 98)) | (1 << (flashcardParser.OpAmpVideoLink - 98)) | (1 << (flashcardParser.OpAmpArticleLink - 98)) | (1 << (flashcardParser.OpAmpDocumentLink - 98)) | (1 << (flashcardParser.OpAmpAppLink - 98)) | (1 << (flashcardParser.OpAmpWebsiteLink - 98)) | (1 << (flashcardParser.OpAmpStillImageFilmLink - 98)))) !== 0) || ((((_la - 132)) & ~0x1F) === 0 && ((1 << (_la - 132)) & ((1 << (flashcardParser.OpAmpVideoEmbed - 132)) | (1 << (flashcardParser.OpAmpAudioEmbed - 132)) | (1 << (flashcardParser.OpAmpDocumentEmbed - 132)) | (1 << (flashcardParser.OpAmpStillImageFilmEmbed - 132)) | (1 << (flashcardParser.URL - 132)) | (1 << (flashcardParser.LIST_LINE - 132)))) !== 0)) {
                    {
                        {
                            this.state = 435;
                            this.bitElem();
    ...
    format() {
        ...
        try {
            ...
            this.enterOuterAlt(_localctx, 1);
            {
                ...
                this._errHandler.sync(this);
                _la = this._input.LA(1);
                while (((((_la - 87)) & ~0x1F) === 0 && ((1 << (_la - 87)) & ((1 << (flashcardParser.AmpAudio - 87)) | (1 << (flashcardParser.AmpImage - 87)) | (1 << (flashcardParser.AmpImageZoom - 87)) | (1 << (flashcardParser.AmpImageWAudio - 87)) | (1 << (flashcardParser.AmpVideo - 87)) | (1 << (flashcardParser.AmpArticle - 87)) | (1 << (flashcardParser.AmpDocument - 87)) | (1 << (flashcardParser.AmpApp - 87)) | (1 << (flashcardParser.AmpWebsite - 87)) | (1 << (flashcardParser.AmpStillImageFilm - 87)) | (1 << (flashcardParser.AmpPdf - 87)) | (1 << (flashcardParser.AmpAudioLink - 87)) | (1 << (flashcardParser.AmpImageLink - 87)) | (1 << (flashcardParser.AmpVideoLink - 87)) | (1 << (flashcardParser.AmpArticleLink - 87)) | (1 << (flashcardParser.AmpDocumentLink - 87)) | (1 << (flashcardParser.AmpAppLink - 87)) | (1 << (flashcardParser.AmpWebsiteLink - 87)) | (1 << (flashcardParser.AmpStillImageFilmLink - 87)))) !== 0) || ((((_la - 127)) & ~0x1F) === 0 && ((1 << (_la - 127)) & ((1 << (flashcardParser.AmpVideoEmbed - 127)) | (1 << (flashcardParser.AmpDocumentEmbed - 127)) | (1 << (flashcardParser.AmpStillImageFilmEmbed - 127)) | (1 << (flashcardParser.ColonText - 127)) | (1 << (flashcardParser.ColonJson - 127)))) !== 0)) {
                    {
                        this.state = 657;
                        this._errHandler.sync(this);
                        switch (this._input.LA(1)) {
    ...
    resource_format() {
        ...
        try {
            this.enterOuterAlt(_localctx, 1);
            {
                this.state = 662;
                _la = this._input.LA(1);
                if (!(((((_la - 92)) & ~0x1F) === 0 && ((1 << (_la - 92)) & ((1 << (flashcardParser.AmpArticle - 92)) | (1 << (flashcardParser.AmpDocument - 92)) | (1 << (flashcardParser.AmpWebsite - 92)) | (1 << (flashcardParser.AmpStillImageFilm - 92)) | (1 << (flashcardParser.AmpAudioLink - 92)) | (1 << (flashcardParser.AmpImageLink - 92)) | (1 << (flashcardParser.AmpVideoLink - 92)) | (1 << (flashcardParser.AmpArticleLink - 92)) | (1 << (flashcardParser.AmpDocumentLink - 92)) | (1 << (flashcardParser.AmpAppLink - 92)) | (1 << (flashcardParser.AmpWebsiteLink - 92)) | (1 << (flashcardParser.AmpStillImageFilmLink - 92)))) !== 0) || ((((_la - 127)) & ~0x1F) === 0 && ((1 << (_la - 127)) & ((1 << (flashcardParser.AmpVideoEmbed - 127)) | (1 << (flashcardParser.AmpAudioEmbed - 127)) | (1 << (flashcardParser.AmpDocumentEmbed - 127)) | (1 << (flashcardParser.AmpStillImageFilmEmbed - 127)) | (1 << (flashcardParser.BitmarkMinus - 127)) | (1 << (flashcardParser.BitmarkPlus - 127)) | (1 << (flashcardParser.ColonJson - 127)) | (1 << (flashcardParser.Prosemirror - 127)) | (1 << (flashcardParser.Placeholder - 127)))) !== 0))) {
                    this._errHandler.recoverInline(this);
                }
                else {
                    if (this._input.LA(1) === Token_1.Token.EOF) {
    ...
    op_document_format() {
        ...
        try {
            this.enterOuterAlt(_localctx, 1);
            {
                this.state = 715;
                _la = this._input.LA(1);
                if (!(((((_la - 105)) & ~0x1F) === 0 && ((1 << (_la - 105)) & ((1 << (flashcardParser.OpAmpDocument - 105)) | (1 << (flashcardParser.OpAmpDocumentLink - 105)) | (1 << (flashcardParser.OpAmpDocumentEmbed - 105)))) !== 0))) {
                    this._errHandler.recoverInline(this);
                }
                else {
                    if (this._input.LA(1) === Token_1.Token.EOF) {
            ...
            switch (this._input.LA(1)) {
                ...
                case flashcardParser.OpAtSearch:
                    this.enterOuterAlt(_localctx, 3);
                    {
                        this.state = 863;
                        _la = this._input.LA(1);
                        if (!(((((_la - 75)) & ~0x1F) === 0 && ((1 << (_la - 75)) & ((1 << (flashcardParser.OPATALT - 75)) | (1 << (flashcardParser.OpAtCaption - 75)) | (1 << (flashcardParser.OpAtLicense - 75)) | (1 << (flashcardParser.OpAtCopyright - 75)) | (1 << (flashcardParser.OpAtSearch - 75)))) !== 0))) {
                            this._errHandler.recoverInline(this);
                        }
                        else {
                            if (this._input.LA(1) === Token_1.Token.EOF) {
...
flashcardParser.AtPartner = 74;
flashcardParser.OPATALT = 75;
flashcardParser.OPAMARK = 76;
flashcardParser.ShowInIndex = 77;
flashcardParser.OpAtCaption = 78;
flashcardParser.OpAtLicense = 79;
flashcardParser.OpAtCopyright = 80;
flashcardParser.OpAtSearch = 81;
flashcardParser.OpAtIsTracked = 82;
flashcardParser.OpAtIsInfoOnly = 83;
flashcardParser.AtDate = 84;
flashcardParser.Http = 85;
flashcardParser.Https = 86;
flashcardParser.AmpAudio = 87;
flashcardParser.AmpImage = 88;
flashcardParser.AmpImageZoom = 89;
flashcardParser.AmpImageWAudio = 90;
flashcardParser.AmpVideo = 91;
flashcardParser.AmpArticle = 92;
flashcardParser.AmpDocument = 93;
flashcardParser.AmpApp = 94;
flashcardParser.AmpWebsite = 95;
flashcardParser.AmpStillImageFilm = 96;
flashcardParser.AmpPdf = 97;
flashcardParser.OpAmpAudio = 98;
flashcardParser.OpAmpImage = 99;
flashcardParser.OpAmpImageZoom = 100;
flashcardParser.OpAmpImageWAudio = 101;
flashcardParser.OpAmpVideo = 102;
flashcardParser.OpAmpArticle = 103;
flashcardParser.OpAmpArticleAtt = 104;
flashcardParser.OpAmpDocument = 105;
flashcardParser.OpAmpApp = 106;
flashcardParser.OpAmpWebsite = 107;
flashcardParser.OpAmpStillImageFilm = 108;
flashcardParser.BracEnclose = 109;
flashcardParser.AmpAudioLink = 110;
flashcardParser.AmpImageLink = 111;
flashcardParser.AmpVideoLink = 112;
flashcardParser.AmpArticleLink = 113;
flashcardParser.AmpDocumentLink = 114;
flashcardParser.AmpAppLink = 115;
flashcardParser.AmpWebsiteLink = 116;
flashcardParser.AmpStillImageFilmLink = 117;
flashcardParser.OpAmpAudioLink = 118;
flashcardParser.OpAmpImageLink = 119;
flashcardParser.OpAmpVideoLink = 120;
flashcardParser.OpAmpArticleLink = 121;
flashcardParser.OpAmpDocumentLink = 122;
flashcardParser.OpAmpAppLink = 123;
flashcardParser.OpAmpWebsiteLink = 124;
flashcardParser.OpAmpStillImageFilmLink = 125;
flashcardParser.AmpImageEmbed = 126;
flashcardParser.AmpVideoEmbed = 127;
flashcardParser.AmpAudioEmbed = 128;
flashcardParser.AmpDocumentEmbed = 129;
flashcardParser.AmpStillImageFilmEmbed = 130;
flashcardParser.OpAmpImageEmbed = 131;
flashcardParser.OpAmpVideoEmbed = 132;
flashcardParser.OpAmpAudioEmbed = 133;
flashcardParser.OpAmpDocumentEmbed = 134;
flashcardParser.OpAmpStillImageFilmEmbed = 135;
flashcardParser.BitmarkMinus = 136;
flashcardParser.BitmarkPlus = 137;
flashcardParser.ColonText = 138;
flashcardParser.ColonJson = 139;
flashcardParser.Prosemirror = 140;
flashcardParser.Placeholder = 141;
flashcardParser.BASIC = 142;
flashcardParser.JPG = 143;
flashcardParser.PNG = 144;
flashcardParser.GIF = 145;
flashcardParser.SVG = 146;
flashcardParser.MP2 = 147;
flashcardParser.MP3 = 148;
flashcardParser.MP4 = 149;
flashcardParser.FLV = 150;
flashcardParser.WMV = 151;
flashcardParser.MPEG = 152;
flashcardParser.MPG = 153;
flashcardParser.TEL = 154;
flashcardParser.DotArticleAtt = 155;
flashcardParser.STAR = 156;
flashcardParser.URL = 157;
flashcardParser.LIST_LINE = 158;
flashcardParser.ENCLBARS = 159;
...
flashcardParser._serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03\xA1\u055E\x04" +
    ...
    "\x02\xAA\x02\xAC\x02\x02\x17\x03\x02+,\x03\x02./\b\x02^_abpw\x81\x84\x8A" +
    "\x8B\x8D\x8F\x05\x02]]rr\x81\x81\x04\x02^^ss\x05\x02__tt\x83\x83\x04\x02" +
    "``uu\x04\x02aavv\x05\x02bbww\x84\x84\x04\x02ii{{\x05\x02kk||\x88\x88\x04" +
    "\x02ll}}\x04\x02mm~~\x05\x02nn\x7F\x7F\x89\x89\x03\x02>?\x04\x02MMPS\x03" +
...
flashcardParser._serializedATNSegment1 = "\u0151\u0144\x03\x02\x02\x02\u0151\u0152\x03\x02\x02\x02\u0152\r\x03\x02" +
    ...
    "\u024B\x05\x1A\x0E\x02\u024B!\x03\x02\x02\x02\u024C\u0264\x07\xA0\x02" +
    ...
    "\x02\x02\u028F\u028D\x03\x02\x02\x02\u0290\u0294\x07\x8C\x02\x02\u0291" +
    "\u0294\x07\x8D\x02\x02\u0292\u0294\x052\x1A\x02\u0293\u0290\x03\x02\x02" +
    ...
    "B\"\x02\u02A2\u02A4\x07c\x02\x02\u02A3\u029A\x03\x02\x02\x02\u02A3\u029B" +
    ...
    "3\x03\x02\x02\x02\u02A5\u02AB\x07\x8A\x02\x02\u02A6\u02AB\x07\x8B\x02" +
    "\x02\u02A7\u02AB\x07\x8C\x02\x02\u02A8\u02AB\x07\x8D\x02\x02\u02A9\u02AB" +
    "\x03\x02\x02\x02\u02AA\u02A5\x03\x02\x02\x02\u02AA\u02A6\x03\x02\x02\x02" +
    "\u02AA\u02A7\x03\x02\x02\x02\u02AA\u02A8\x03\x02\x02\x02\u02AA\u02A9\x03" +
    "\x02\x02\x02\u02AB5\x03\x02\x02\x02\u02AC\u02AF\x07Z\x02\x02\u02AD\u02B0" +
    "\x07\r\x02\x02\u02AE\u02B0\x07\x9D\x02\x02\u02AF\u02AD\x03\x02\x02\x02" +
    "\u02AF\u02AE\x03\x02\x02\x02\u02AF\u02B0\x03\x02\x02\x02\u02B0\u02BB\x03" +
    "\x02\x02\x02\u02B1\u02B3\x07q\x02\x02\u02B2\u02B4\x07\r\x02\x02\u02B3" +
    "\u02B2\x03\x02\x02\x02\u02B3\u02B4\x03\x02\x02\x02\u02B4\u02BB\x03\x02" +
    "\x02\x02\u02B5\u02B7\x07[\x02\x02\u02B6\u02B8\x07\r\x02\x02\u02B7\u02B6" +
    ...
    "\u0308\u030D\x07 \x02\x02\u0309\u030A\x07M\x02\x02\u030A\u030B\x05\xAA" +
    ...
    "\u032B\x05v<\x02\u032B\u0330\x07 \x02\x02\u032C\u032D\x07M\x02\x02\u032D" +
    ...
    "\x02\x02\u0339\u033A\x077\x02\x02\u033A\u033C\x07O\x02\x02\u033B\u0339" +
    ...
    "\u0347c\x03\x02\x02\x02\u0348\u034B\x07e\x02\x02\u0349\u034C\x07\r\x02" +
    "\x02\u034A\u034C\x07\x9D\x02\x02\u034B\u0349\x03\x02\x02\x02\u034B\u034A" +
    "\x03\x02\x02\x02\u034B\u034C\x03\x02\x02\x02\u034C\u0357\x03\x02\x02\x02" +
    "\u034D\u034F\x07y\x02\x02\u034E\u0350\x07\r\x02\x02\u034F\u034E\x03\x02" +
    "\x02\x02\u034F\u0350\x03\x02\x02\x02\u0350\u0357\x03\x02\x02\x02\u0351" +
    "\u0353\x07f\x02\x02\u0352\u0354\x07\r\x02\x02\u0353\u0352\x03\x02\x02" +
    "\x02\u0353\u0354\x03\x02\x02\x02\u0354\u0357\x03\x02\x02\x02\u0355\u0357" +
    "\x07g\x02\x02\u0356\u0348\x03\x02\x02\x02\u0356\u034D\x03\x02\x02\x02" +
    ...
    "M\x02\x02\u038A\u038B\x05\xAAV\x02\u038B\u038C\x07 \x02\x02\u038C\u038E" +
    "\x03\x02\x02\x02\u038D\u0389\x03\x02\x02\x02\u038D\u038E\x03\x02\x02\x02" +
    "\u038Em\x03\x02\x02\x02\u038F\u0392\x07Y\x02\x02\u0390\u0391\x07!\x02" +
    "\x02\u0391\u0393\x07\x0E\x02\x02\u0392\u0390\x03\x02\x02\x02\u0392\u0393" +
    "\x03\x02\x02\x02\u0393\u039A\x03\x02\x02\x02\u0394\u0397\x07p\x02\x02" +
    ...
    "\x02\u039B\u039E\x07d\x02\x02\u039C\u039D\x07!\x02\x02\u039D\u039F\x07" +
    "\x0E\x02\x02\u039E\u039C\x03\x02\x02\x02\u039E\u039F\x03\x02\x02\x02\u039F" +
    "\u03AB\x03\x02\x02\x02\u03A0\u03A3\x07x\x02\x02\u03A1\u03A2\x07!\x02\x02" +
    "\u03A2\u03A4\x07\x0E\x02\x02\u03A3\u03A1\x03\x02\x02\x02\u03A3\u03A4\x03" +
    "\x02\x02\x02\u03A4\u03AB\x03\x02\x02\x02\u03A5\u03A8\x07\x87\x02\x02\u03A6" +
    ...
    "\x02\x02\x02\u03CCs\x03\x02\x02\x02\u03CD\u03CE\x07\x9C\x02\x02\u03CE" +
    "\u03CF\x07$\x02\x02\u03CF\u03D0\x075\x02\x02\u03D0u\x03\x02\x02\x02\u03D1" +
    "\u03D2\x07\x9F\x02\x02\u03D2w\x03\x02\x02\x02\u03D3\u03D4\x07\x1E\x02" +
...
flashcardParser._serializedATNSegment2 = "\x03\x02\x02\x02\u03F9\u03FA\x03\x02\x02\x02\u03FA\u03FC\x03\x02\x02\x02" +
    ...
    "\x7F\x03\x02\x02\x02\u0413\u0415\x07o\x02\x02\u0414\u0416\x05\xA4S\x02" +
    ...
    "\u043B\x07 \x02\x02\u0430\u0436\x07o\x02\x02\u0431\u0435\x05\xA4S\x02" +
    ...
    "\x05\xA4S\x02\u043E\u0442\x07!\x02\x02\u043F\u0442\x07\x9F\x02\x02\u0440" +
    ...
    "\x07\x9F\x02\x02\u044A\u044D\x077\x02\x02\u044B\u044D\x07\x04\x02\x02" +
    ...
    "\u045C\x07V\x02\x02\u0459\u045D\x05\xA4S\x02\u045A\u045D\x07!\x02\x02" +
    ...
    "\u0464\u0468\x07V\x02\x02\u0465\u0469\x05\xA4S\x02\u0466\u0469\x07!\x02" +
    ...
    "\x93\x03\x02\x02\x02\u04C9\u04CA\x07T\x02\x02\u04CA\u04CB\x05\xA4S\x02" +
    "\u04CB\u04CC\x07 \x02\x02\u04CC\x95\x03\x02\x02\x02\u04CD\u04CE\x07U\x02" +
    ...
    "\x03\x02\x02\x02\u04EC\u04F0\x07R\x02\x02\u04ED\u04EF\v\x02\x02\x02\u04EE" +
    ...
    "\u0548\x07\x9F\x02\x02\u0547\u051B\x03\x02\x02\x02\u0547\u0524\x03\x02" +
