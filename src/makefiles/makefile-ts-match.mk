...
es6: $(grammar_file)
	python replace_parser_content.py ./Match/_matchLexer.g4 ./typescript/common_lexer.g4 ./Match/matchLexer.g4 '<<<<<<common<<<<<<'
	python replace_parser_content.py ./Match/_matchParser.g4 ./typescript/common_parser.g4 ./Match/matchParser.g4 '<<<<<<common<<<<<<'
