...
es6: $(grammar_file)
	python3 tools/replace_parser_content.py $(grammar_dir)/_clozeLexer.g4 $(common_lexer)   $(build_dir)/clozeLexer.g4 '<<<<<<common<<<<<<'
	python3 tools/replace_parser_content.py $(grammar_dir)/_clozeParser.g4 $(common_parser) $(build_dir)/clozeParser.g4 '<<<<<<common<<<<<<'
