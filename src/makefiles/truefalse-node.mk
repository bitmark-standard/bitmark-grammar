...
es6: $(grammar_file)
	python ./tools/replace_parser_content.py ./Truefalse/_truefalseLexer.g4 ./typescript/common_lexer.g4 ./Truefalse/truefalseLexer.g4 '<<<<<<common<<<<<<'
	python ./tools/replace_parser_content.py ./Truefalse/_truefalseParser.g4 ./typescript/common_parser.g4 ./Truefalse/truefalseParser.g4 '<<<<<<common<<<<<<'
