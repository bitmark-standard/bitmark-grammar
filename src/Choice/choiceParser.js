...
let choiceParser = /** @class */ (() => {
    ...
    choiceParser.OpAmpAudio = 92;
    choiceParser.OpAmpImage = 93;
    choiceParser.OpAmpImageZoom = 94;
    choiceParser.OpAmpImageWAudio = 95;
    choiceParser.OpAmpVideo = 96;
    choiceParser.OpAmpArticle = 97;
    choiceParser.OpAmpArticleAtt = 98;
    choiceParser.OpAmpDocument = 99;
    choiceParser.OpAmpApp = 100;
    choiceParser.OpAmpWebsite = 101;
    choiceParser.OpAmpStillImageFilm = 102;
    choiceParser.BracEnclose = 103;
    choiceParser.AmpAudioLink = 104;
    choiceParser.AmpImageLink = 105;
    choiceParser.AmpVideoLink = 106;
    choiceParser.AmpArticleLink = 107;
    choiceParser.AmpDocumentLink = 108;
    choiceParser.AmpAppLink = 109;
    choiceParser.AmpWebsiteLink = 110;
    choiceParser.AmpStillImageFilmLink = 111;
    choiceParser.OpAmpAudioLink = 112;
    choiceParser.OpAmpImageLink = 113;
    choiceParser.OpAmpVideoLink = 114;
    choiceParser.OpAmpArticleLink = 115;
    choiceParser.OpAmpDocumentLink = 116;
    choiceParser.OpAmpAppLink = 117;
    choiceParser.OpAmpWebsiteLink = 118;
    choiceParser.OpAmpStillImageFilmLink = 119;
    choiceParser.BitmarkMinus = 120;
    choiceParser.BitmarkPlus = 121;
    choiceParser.ColonText = 122;
    choiceParser.BASIC = 123;
    choiceParser.JPG = 124;
    choiceParser.PNG = 125;
    choiceParser.GIF = 126;
    choiceParser.SVG = 127;
    choiceParser.MP2 = 128;
    choiceParser.MP3 = 129;
    choiceParser.MP4 = 130;
    choiceParser.FLV = 131;
    choiceParser.WMV = 132;
    choiceParser.MPEG = 133;
    choiceParser.MPG = 134;
    choiceParser.TEL = 135;
    choiceParser.DotArticleAtt = 136;
    choiceParser.STAR = 137;
    choiceParser.URL = 138;
    choiceParser.LIST_LINE = 139;
    ...
    choiceParser._serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03\x8D\u05DF\x04" +
    ...
    choiceParser._serializedATNSegment1 = "\x03\x02\x02\x02\u0131\u0132\x03\x02\x02\x02\u0132\u0135\x03\x02\x02\x02" +
        ...
        "\u03D4\u03D7\x03\x02";
    choiceParser._serializedATNSegment2 = "\x02\x02\u03D5\u03D3\x03\x02\x02\x02\u03D5\u03D6\x03\x02\x02\x02\u03D6" +
