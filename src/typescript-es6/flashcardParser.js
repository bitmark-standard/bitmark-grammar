...
flashcardParser.AtSampleSolution = 68;
flashcardParser.AtPartialAnswerS = 69;
flashcardParser.AtPartialAnswer = 70;
flashcardParser.AtLabeltrue = 71;
flashcardParser.AtLabelfalse = 72;
flashcardParser.AtPoints = 73;
flashcardParser.AtSrc = 74;
flashcardParser.AtPartner = 75;
flashcardParser.OPATALT = 76;
flashcardParser.OPAMARK = 77;
flashcardParser.ShowInIndex = 78;
flashcardParser.OpAtCaption = 79;
flashcardParser.OpAtLicense = 80;
flashcardParser.OpAtCopyright = 81;
flashcardParser.OpAtSearch = 82;
flashcardParser.OpAtIsTracked = 83;
flashcardParser.OpAtIsInfoOnly = 84;
flashcardParser.AtDate = 85;
flashcardParser.Http = 86;
flashcardParser.Https = 87;
flashcardParser.AmpAudio = 88;
flashcardParser.AmpImage = 89;
flashcardParser.AmpImageZoom = 90;
flashcardParser.AmpImageWAudio = 91;
flashcardParser.AmpVideo = 92;
flashcardParser.AmpArticle = 93;
flashcardParser.AmpDocument = 94;
flashcardParser.AmpApp = 95;
flashcardParser.AmpWebsite = 96;
flashcardParser.AmpStillImageFilm = 97;
flashcardParser.AmpPdf = 98;
flashcardParser.OpAmpAudio = 99;
flashcardParser.OpAmpImage = 100;
flashcardParser.OpAmpImageZoom = 101;
flashcardParser.OpAmpImageWAudio = 102;
flashcardParser.OpAmpVideo = 103;
flashcardParser.OpAmpArticle = 104;
flashcardParser.OpAmpArticleAtt = 105;
flashcardParser.OpAmpDocument = 106;
flashcardParser.OpAmpApp = 107;
flashcardParser.OpAmpWebsite = 108;
flashcardParser.OpAmpStillImageFilm = 109;
flashcardParser.BracEnclose = 110;
flashcardParser.AmpAudioLink = 111;
flashcardParser.AmpImageLink = 112;
flashcardParser.AmpVideoLink = 113;
flashcardParser.AmpArticleLink = 114;
flashcardParser.AmpDocumentLink = 115;
flashcardParser.AmpDocumentDownload = 116;
flashcardParser.AmpAppLink = 117;
flashcardParser.AmpWebsiteLink = 118;
flashcardParser.AmpStillImageFilmLink = 119;
flashcardParser.OpAmpAudioLink = 120;
flashcardParser.OpAmpImageLink = 121;
flashcardParser.OpAmpVideoLink = 122;
flashcardParser.OpAmpArticleLink = 123;
flashcardParser.OpAmpDocumentLink = 124;
flashcardParser.OpAmpDocumentDownload = 125;
flashcardParser.OpAmpAppLink = 126;
flashcardParser.OpAmpWebsiteLink = 127;
flashcardParser.OpAmpStillImageFilmLink = 128;
flashcardParser.AmpImageEmbed = 129;
flashcardParser.AmpVideoEmbed = 130;
flashcardParser.AmpAudioEmbed = 131;
flashcardParser.AmpDocumentEmbed = 132;
flashcardParser.AmpStillImageFilmEmbed = 133;
flashcardParser.OpAmpImageEmbed = 134;
flashcardParser.OpAmpVideoEmbed = 135;
flashcardParser.OpAmpAudioEmbed = 136;
flashcardParser.OpAmpDocumentEmbed = 137;
flashcardParser.OpAmpStillImageFilmEmbed = 138;
flashcardParser.BitmarkMinus = 139;
flashcardParser.BitmarkPlus = 140;
flashcardParser.ColonText = 141;
flashcardParser.ColonJson = 142;
flashcardParser.Prosemirror = 143;
flashcardParser.Placeholder = 144;
flashcardParser.BASIC = 145;
flashcardParser.JPG = 146;
flashcardParser.PNG = 147;
flashcardParser.GIF = 148;
flashcardParser.SVG = 149;
flashcardParser.MP2 = 150;
flashcardParser.MP3 = 151;
flashcardParser.MP4 = 152;
flashcardParser.FLV = 153;
flashcardParser.WMV = 154;
flashcardParser.MPEG = 155;
flashcardParser.MPG = 156;
flashcardParser.TEL = 157;
flashcardParser.DotArticleAtt = 158;
flashcardParser.STAR = 159;
flashcardParser.URL = 160;
flashcardParser.LIST_LINE = 161;
flashcardParser.ENCLBARS = 162;
...
flashcardParser._serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03\xA4\u055E\x04" +
