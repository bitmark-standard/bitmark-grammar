...
let bitmarkParser = /** @class */ (() => {
    ...
    bitmarkParser.COMMENT = 70;
    bitmarkParser.Image_type = 71;
    bitmarkParser.Audio_type = 72;
    bitmarkParser.Video_type = 73;
    bitmarkParser.OPDOLL = 74;
    bitmarkParser.OPBUL = 75;
    bitmarkParser.OPESC = 76;
    bitmarkParser.OPRANGLES = 77;
    bitmarkParser.OPRANGLEL = 78;
    bitmarkParser.OPDANGLE = 79;
    bitmarkParser.OPU = 80;
    bitmarkParser.OPB = 81;
    bitmarkParser.OPQ = 82;
    bitmarkParser.OPA = 83;
    bitmarkParser.OPP = 84;
    bitmarkParser.OPM = 85;
    bitmarkParser.OPS = 86;
    bitmarkParser.OPR = 87;
    bitmarkParser.OPHASH = 88;
    bitmarkParser.OPC = 89;
    bitmarkParser.CL = 90;
    bitmarkParser.COLON = 91;
    bitmarkParser.AMP = 92;
    bitmarkParser.DBLCOLON = 93;
    bitmarkParser.PLUS = 94;
    bitmarkParser.DotAt = 95;
    bitmarkParser.Greater = 96;
    bitmarkParser.Less = 97;
    bitmarkParser.RightAngle = 98;
    bitmarkParser.RightArrow = 99;
    bitmarkParser.DBLEQ = 100;
    bitmarkParser.HSPL = 101;
    bitmarkParser.HSPL2 = 102;
    bitmarkParser.SSPL = 103;
    bitmarkParser.SSPL2 = 104;
    bitmarkParser.QUOTE_INDEX = 105;
    bitmarkParser.DCANY = 106;
    bitmarkParser.ArticleText = 107;
    bitmarkParser.NOTCL = 108;
    bitmarkParser.NUMERIC = 109;
    bitmarkParser.STRING = 110;
    bitmarkParser.NL = 111;
    bitmarkParser.SENTENCE = 112;
    bitmarkParser.OPAT = 113;
    bitmarkParser.AtProgress = 114;
    bitmarkParser.AtReference = 115;
    bitmarkParser.AtWidth = 116;
    bitmarkParser.AtHeight = 117;
    bitmarkParser.AtProgressPoints = 118;
    bitmarkParser.AtShortanswer = 119;
    bitmarkParser.AtLonganswer = 120;
    bitmarkParser.AtExampleWithStr = 121;
    bitmarkParser.AtExamplecol = 122;
    bitmarkParser.AtExamplecl = 123;
    bitmarkParser.AtPartialAnswerS = 124;
    bitmarkParser.AtPartialAnswer = 125;
    bitmarkParser.AtLabeltrue = 126;
    bitmarkParser.AtLabelfalse = 127;
    bitmarkParser.AtPoints = 128;
    bitmarkParser.AtSrc = 129;
    bitmarkParser.OPATALT = 130;
    bitmarkParser.OPAMARK = 131;
    bitmarkParser.ShowInIndex = 132;
    bitmarkParser.OpAtCaption = 133;
    bitmarkParser.OpAtLicense = 134;
    bitmarkParser.OpAtCopyright = 135;
    bitmarkParser.OpAtIsTracked = 136;
    bitmarkParser.OpAtIsInfoOnly = 137;
    bitmarkParser.AtDate = 138;
    bitmarkParser.Http = 139;
    bitmarkParser.Https = 140;
    bitmarkParser.AmpAudio = 141;
    bitmarkParser.AmpImage = 142;
    bitmarkParser.AmpImageZoom = 143;
    bitmarkParser.AmpImageWAudio = 144;
    bitmarkParser.AmpVideo = 145;
    bitmarkParser.AmpArticle = 146;
    bitmarkParser.AmpDocument = 147;
    bitmarkParser.AmpApp = 148;
    bitmarkParser.AmpWebsite = 149;
    bitmarkParser.AmpStillImageFilm = 150;
    bitmarkParser.AmpPdf = 151;
    bitmarkParser.OpAmpAudio = 152;
    bitmarkParser.OpAmpImage = 153;
    bitmarkParser.OpAmpImageZoom = 154;
    bitmarkParser.OpAmpImageWAudio = 155;
    bitmarkParser.OpAmpVideo = 156;
    bitmarkParser.OpAmpArticle = 157;
    bitmarkParser.OpAmpArticleAtt = 158;
    bitmarkParser.OpAmpDocument = 159;
    bitmarkParser.OpAmpApp = 160;
    bitmarkParser.OpAmpWebsite = 161;
    bitmarkParser.OpAmpStillImageFilm = 162;
    bitmarkParser.BracEnclose = 163;
    bitmarkParser.AmpAudioLink = 164;
    bitmarkParser.AmpImageLink = 165;
    bitmarkParser.AmpVideoLink = 166;
    bitmarkParser.AmpArticleLink = 167;
    bitmarkParser.AmpDocumentLink = 168;
    bitmarkParser.AmpAppLink = 169;
    bitmarkParser.AmpWebsiteLink = 170;
    bitmarkParser.AmpStillImageFilmLink = 171;
    bitmarkParser.OpAmpAudioLink = 172;
    bitmarkParser.OpAmpImageLink = 173;
    bitmarkParser.OpAmpVideoLink = 174;
    bitmarkParser.OpAmpArticleLink = 175;
    bitmarkParser.OpAmpDocumentLink = 176;
    bitmarkParser.OpAmpAppLink = 177;
    bitmarkParser.OpAmpWebsiteLink = 178;
    bitmarkParser.OpAmpStillImageFilmLink = 179;
    bitmarkParser.BitmarkMinus = 180;
    bitmarkParser.BitmarkPlus = 181;
    bitmarkParser.ColonText = 182;
    bitmarkParser.Prosemirror = 183;
    bitmarkParser.Placeholder = 184;
    bitmarkParser.BASIC = 185;
    bitmarkParser.JPG = 186;
    bitmarkParser.PNG = 187;
    bitmarkParser.GIF = 188;
    bitmarkParser.SVG = 189;
    bitmarkParser.MP2 = 190;
    bitmarkParser.MP3 = 191;
    bitmarkParser.MP4 = 192;
    bitmarkParser.FLV = 193;
    bitmarkParser.WMV = 194;
    bitmarkParser.MPEG = 195;
    bitmarkParser.MPG = 196;
    bitmarkParser.TEL = 197;
    bitmarkParser.DotArticleAtt = 198;
    bitmarkParser.STAR = 199;
    bitmarkParser.URL = 200;
    bitmarkParser.LIST_LINE = 201;
    ...
    bitmarkParser.RULE_message = 69;
    bitmarkParser.RULE_bot_interview = 70;
    bitmarkParser.RULE_bot_choice = 71;
    bitmarkParser.RULE_rating = 72;
    bitmarkParser.RULE_bullet_item = 73;
    bitmarkParser.RULE_survey = 74;
    bitmarkParser.RULE_survey_1 = 75;
    bitmarkParser.RULE_survey_anonymous = 76;
    bitmarkParser.RULE_survey_anonymous_1 = 77;
    bitmarkParser.RULE_self_assessment = 78;
    bitmarkParser.RULE_self_assess_s_and_w = 79;
    bitmarkParser.RULE_atpoint = 80;
    bitmarkParser.RULE_format = 81;
    bitmarkParser.RULE_resource_format = 82;
    bitmarkParser.RULE_resource_format_extra = 83;
    bitmarkParser.RULE_image_format = 84;
    bitmarkParser.RULE_video_format = 85;
    bitmarkParser.RULE_article_format = 86;
    bitmarkParser.RULE_document_format = 87;
    bitmarkParser.RULE_app_format = 88;
    bitmarkParser.RULE_website_format = 89;
    bitmarkParser.RULE_stillimagefilm_format = 90;
    bitmarkParser.RULE_op_article_format = 91;
    bitmarkParser.RULE_op_document_format = 92;
    bitmarkParser.RULE_op_app_format = 93;
    bitmarkParser.RULE_op_website_format = 94;
    bitmarkParser.RULE_op_video_format = 95;
    bitmarkParser.RULE_op_stillimagefilm_format = 96;
    bitmarkParser.RULE_articlebit = 97;
    bitmarkParser.RULE_documentbit = 98;
    bitmarkParser.RULE_websitebit = 99;
    bitmarkParser.RULE_appbit = 100;
    bitmarkParser.RULE_stillimagefilmbit = 101;
    bitmarkParser.RULE_stillimg_one = 102;
    bitmarkParser.RULE_videobit = 103;
    bitmarkParser.RULE_video_one = 104;
    bitmarkParser.RULE_imagebit = 105;
    bitmarkParser.RULE_image_one = 106;
    bitmarkParser.RULE_op_image_format = 107;
    bitmarkParser.RULE_image_chained = 108;
    bitmarkParser.RULE_image_chained4match = 109;
    bitmarkParser.RULE_audiobit = 110;
    bitmarkParser.RULE_audio_one = 111;
    bitmarkParser.RULE_audio_format = 112;
    bitmarkParser.RULE_op_audio_format = 113;
    bitmarkParser.RULE_resource_chained = 114;
    bitmarkParser.RULE_telephone = 115;
    bitmarkParser.RULE_url = 116;
    bitmarkParser.RULE_item = 117;
    bitmarkParser.RULE_lead = 118;
    bitmarkParser.RULE_angleref = 119;
    bitmarkParser.RULE_example = 120;
    bitmarkParser.RULE_bracketed_text = 121;
    bitmarkParser.RULE_reference = 122;
    bitmarkParser.RULE_progress = 123;
    bitmarkParser.RULE_dateprop = 124;
    bitmarkParser.RULE_dateprop_chained = 125;
    bitmarkParser.RULE_instruction = 126;
    bitmarkParser.RULE_hint = 127;
    bitmarkParser.RULE_title = 128;
    bitmarkParser.RULE_bool_label = 129;
    bitmarkParser.RULE_progress_points = 130;
    bitmarkParser.RULE_istracked = 131;
    bitmarkParser.RULE_isinfoonly = 132;
    bitmarkParser.RULE_atdef = 133;
    bitmarkParser.RULE_atdef_ = 134;
    bitmarkParser.RULE_dollarans = 135;
    bitmarkParser.RULE_anchor = 136;
    bitmarkParser.RULE_lines = 137;
    bitmarkParser.RULE_s_and_w = 138;
    bitmarkParser.RULE_dclines = 139;
    bitmarkParser.RULE_bracket_escaped = 140;
    bitmarkParser.RULE_clnsp = 141;
    bitmarkParser.RULE_sspl = 142;
    bitmarkParser.RULE_words = 143;
    bitmarkParser.RULE_sp = 144;
    bitmarkParser.RULE_sentence = 145;
    ...
    bitmarkParser._serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03\xCB\u0B16\x04" +
        ...
        "\x03f\x03f\x05f\u08B9\nf\x03g\x03";
    bitmarkParser._serializedATNSegment1 = "g\x07g\u08BD\ng\fg\x0Eg\u08C0\vg\x03h\x03h\x03h\x07h\u08C5\nh\fh\x0Eh" +
        ...
        "\x02\x02\u0245\u0248\x03\x02";
    bitmarkParser._serializedATNSegment2 = "\x02\x02\u0246\u0244\x03\x02\x02\x02\u0246\u0247\x03\x02\x02\x02\u0247" +
        ...
        "\x02\x02\x02";
    bitmarkParser._serializedATNSegment3 = "\u04FA\u04F3\x03\x02\x02\x02\u04FB\u04FE\x03\x02\x02\x02\u04FC\u04FA\x03" +
    ...
    bitmarkParser._serializedATNSegment4 = "\x03\x02\x02\x02\u07C7\u07C0\x03\x02\x02\x02\u07C8\u07CB\x03\x02\x02\x02" +
    ...
    bitmarkParser._serializedATNSegment5 = "\x8C\x02\u0A7F\u0A7C\x03\x02\x02\x02\u0A7F\u0A7D\x03\x02\x02\x02\u0A7F" +
