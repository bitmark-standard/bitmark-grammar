...
export class bitmarkParser extends Parser {
	...
	public static readonly Image_type = 74;
	public static readonly Audio_type = 75;
	public static readonly Video_type = 76;
	public static readonly OPDOLL = 77;
	public static readonly OPBUL = 78;
	public static readonly OPESC = 79;
	public static readonly OPRANGLES = 80;
	public static readonly OPRANGLEL = 81;
	public static readonly OPDANGLE = 82;
	public static readonly OPU = 83;
	public static readonly OPB = 84;
	public static readonly OPQ = 85;
	public static readonly OPA = 86;
	public static readonly OPP = 87;
	public static readonly OPM = 88;
	public static readonly OPS = 89;
	public static readonly OPR = 90;
	public static readonly OPHASH = 91;
	public static readonly OPC = 92;
	public static readonly CL = 93;
	public static readonly COLON = 94;
	public static readonly AMP = 95;
	public static readonly DBLCOLON = 96;
	public static readonly PLUS = 97;
	public static readonly DotAt = 98;
	public static readonly Greater = 99;
	public static readonly Less = 100;
	public static readonly RightAngle = 101;
	public static readonly RightArrow = 102;
	public static readonly DBLEQ = 103;
	public static readonly HSPL = 104;
	public static readonly HSPL2 = 105;
	public static readonly SSPL = 106;
	public static readonly SSPL2 = 107;
	public static readonly QUOTE_INDEX = 108;
	public static readonly DCANY = 109;
	public static readonly ArticleText = 110;
	public static readonly NOTCL = 111;
	public static readonly NUMERIC = 112;
	public static readonly STRING = 113;
	public static readonly NL = 114;
	public static readonly SENTENCE = 115;
	public static readonly OPAT = 116;
	public static readonly AtProgress = 117;
	public static readonly AtReference = 118;
	public static readonly AtWidth = 119;
	public static readonly AtHeight = 120;
	public static readonly AtProgressPoints = 121;
	public static readonly AtShortanswer = 122;
	public static readonly AtLonganswer = 123;
	public static readonly AtExampleWithStr = 124;
	public static readonly AtExamplecol = 125;
	public static readonly AtExamplecl = 126;
	public static readonly AtPartialAnswerS = 127;
	public static readonly AtPartialAnswer = 128;
	public static readonly AtLabeltrue = 129;
	public static readonly AtLabelfalse = 130;
	public static readonly AtPoints = 131;
	public static readonly AtSrc = 132;
	public static readonly OPATALT = 133;
	public static readonly OPAMARK = 134;
	public static readonly ShowInIndex = 135;
	public static readonly OpAtCaption = 136;
	public static readonly OpAtLicense = 137;
	public static readonly OpAtCopyright = 138;
	public static readonly OpAtSearch = 139;
	public static readonly OpAtIsTracked = 140;
	public static readonly OpAtIsInfoOnly = 141;
	public static readonly AtDate = 142;
	public static readonly Http = 143;
	public static readonly Https = 144;
	public static readonly AmpAudio = 145;
	public static readonly AmpImage = 146;
	public static readonly AmpImageZoom = 147;
	public static readonly AmpImageWAudio = 148;
	public static readonly AmpVideo = 149;
	public static readonly AmpArticle = 150;
	public static readonly AmpDocument = 151;
	public static readonly AmpApp = 152;
	public static readonly AmpWebsite = 153;
	public static readonly AmpStillImageFilm = 154;
	public static readonly AmpPdf = 155;
	public static readonly OpAmpAudio = 156;
	public static readonly OpAmpImage = 157;
	public static readonly OpAmpImageZoom = 158;
	public static readonly OpAmpImageWAudio = 159;
	public static readonly OpAmpVideo = 160;
	public static readonly OpAmpArticle = 161;
	public static readonly OpAmpArticleAtt = 162;
	public static readonly OpAmpDocument = 163;
	public static readonly OpAmpApp = 164;
	public static readonly OpAmpWebsite = 165;
	public static readonly OpAmpStillImageFilm = 166;
	public static readonly BracEnclose = 167;
	public static readonly AmpAudioLink = 168;
	public static readonly AmpImageLink = 169;
	public static readonly AmpVideoLink = 170;
	public static readonly AmpArticleLink = 171;
	public static readonly AmpDocumentLink = 172;
	public static readonly AmpAppLink = 173;
	public static readonly AmpWebsiteLink = 174;
	public static readonly AmpStillImageFilmLink = 175;
	public static readonly OpAmpAudioLink = 176;
	public static readonly OpAmpImageLink = 177;
	public static readonly OpAmpVideoLink = 178;
	public static readonly OpAmpArticleLink = 179;
	public static readonly OpAmpDocumentLink = 180;
	public static readonly OpAmpAppLink = 181;
	public static readonly OpAmpWebsiteLink = 182;
	public static readonly OpAmpStillImageFilmLink = 183;
	public static readonly BitmarkMinus = 184;
	public static readonly BitmarkPlus = 185;
	public static readonly ColonText = 186;
	public static readonly Prosemirror = 187;
	public static readonly Placeholder = 188;
	public static readonly BASIC = 189;
	public static readonly JPG = 190;
	public static readonly PNG = 191;
	public static readonly GIF = 192;
	public static readonly SVG = 193;
	public static readonly MP2 = 194;
	public static readonly MP3 = 195;
	public static readonly MP4 = 196;
	public static readonly FLV = 197;
	public static readonly WMV = 198;
	public static readonly MPEG = 199;
	public static readonly MPG = 200;
	public static readonly TEL = 201;
	public static readonly DotArticleAtt = 202;
	public static readonly STAR = 203;
	public static readonly URL = 204;
	public static readonly LIST_LINE = 205;
	...
	public static readonly RULE_bot_interview = 73;
	public static readonly RULE_bot_choice = 74;
	public static readonly RULE_rating = 75;
	public static readonly RULE_bullet_item = 76;
	public static readonly RULE_survey = 77;
	public static readonly RULE_survey_1 = 78;
	public static readonly RULE_survey_anonymous = 79;
	public static readonly RULE_survey_anonymous_1 = 80;
	public static readonly RULE_self_assessment = 81;
	public static readonly RULE_self_assess_s_and_w = 82;
	public static readonly RULE_atpoint = 83;
	public static readonly RULE_format = 84;
	public static readonly RULE_resource_format = 85;
	public static readonly RULE_resource_format_extra = 86;
	public static readonly RULE_image_format = 87;
	public static readonly RULE_video_format = 88;
	public static readonly RULE_article_format = 89;
	public static readonly RULE_document_format = 90;
	public static readonly RULE_app_format = 91;
	public static readonly RULE_website_format = 92;
	public static readonly RULE_stillimagefilm_format = 93;
	public static readonly RULE_op_article_format = 94;
	public static readonly RULE_op_document_format = 95;
	public static readonly RULE_op_app_format = 96;
	public static readonly RULE_op_website_format = 97;
	public static readonly RULE_op_video_format = 98;
	public static readonly RULE_op_stillimagefilm_format = 99;
	public static readonly RULE_articlebit = 100;
	public static readonly RULE_documentbit = 101;
	public static readonly RULE_websitebit = 102;
	public static readonly RULE_appbit = 103;
	public static readonly RULE_stillimagefilmbit = 104;
	public static readonly RULE_stillimg_one = 105;
	public static readonly RULE_videobit = 106;
	public static readonly RULE_video_one = 107;
	public static readonly RULE_imagebit = 108;
	public static readonly RULE_image_one = 109;
	public static readonly RULE_op_image_format = 110;
	public static readonly RULE_image_chained = 111;
	public static readonly RULE_image_chained4match = 112;
	public static readonly RULE_audiobit = 113;
	public static readonly RULE_audio_one = 114;
	public static readonly RULE_audio_format = 115;
	public static readonly RULE_op_audio_format = 116;
	public static readonly RULE_resource_chained = 117;
	public static readonly RULE_telephone = 118;
	public static readonly RULE_url = 119;
	public static readonly RULE_item = 120;
	public static readonly RULE_lead = 121;
	public static readonly RULE_angleref = 122;
	public static readonly RULE_example = 123;
	public static readonly RULE_bracketed_text = 124;
	public static readonly RULE_reference = 125;
	public static readonly RULE_progress = 126;
	public static readonly RULE_dateprop = 127;
	public static readonly RULE_dateprop_chained = 128;
	public static readonly RULE_instruction = 129;
	public static readonly RULE_hint = 130;
	public static readonly RULE_title = 131;
	public static readonly RULE_bool_label = 132;
	public static readonly RULE_progress_points = 133;
	public static readonly RULE_istracked = 134;
	public static readonly RULE_isinfoonly = 135;
	public static readonly RULE_atdef = 136;
	public static readonly RULE_atdef_ = 137;
	public static readonly RULE_dollarans = 138;
	public static readonly RULE_anchor = 139;
	public static readonly RULE_lines = 140;
	public static readonly RULE_s_and_w = 141;
	public static readonly RULE_dclines = 142;
	public static readonly RULE_bracket_escaped = 143;
	public static readonly RULE_clnsp = 144;
	public static readonly RULE_sspl = 145;
	public static readonly RULE_words = 146;
	public static readonly RULE_sp = 147;
	public static readonly RULE_sentence = 148;
	...
	private static readonly _serializedATNSegment2: string =
		"\u0227\x03\x02\x02\x02\u022A\u022E\x05:\x1E\x02\u022B\u022D\x07t\x02\x02" +
	...
	private static readonly _serializedATNSegment3: string =
		"t\x02\x02\u04DF\u04DE\x03\x02\x02\x02\u04E0\u04E3\x03\x02\x02\x02\u04E1" +
	...
	private static readonly _serializedATNSegment4: string =
		"\x02\u07AB\u07B5\x05L\'\x02\u07AC\u07AE\x07t\x02\x02\u07AD\u07AC\x03\x02" +
