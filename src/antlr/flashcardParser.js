...
flashcardParser.AmpDocumentDownload = 115;
...
flashcardParser.OpAmpDocumentDownload = 124;
flashcardParser.OpAmpAppLink = 125;
flashcardParser.OpAmpWebsiteLink = 126;
flashcardParser.OpAmpStillImageFilmLink = 127;
flashcardParser.AmpImageEmbed = 128;
flashcardParser.AmpVideoEmbed = 129;
flashcardParser.AmpAudioEmbed = 130;
flashcardParser.AmpDocumentEmbed = 131;
flashcardParser.AmpStillImageFilmEmbed = 132;
flashcardParser.OpAmpImageEmbed = 133;
flashcardParser.OpAmpVideoEmbed = 134;
flashcardParser.OpAmpAudioEmbed = 135;
flashcardParser.OpAmpDocumentEmbed = 136;
flashcardParser.OpAmpStillImageFilmEmbed = 137;
flashcardParser.BitmarkMinus = 138;
flashcardParser.BitmarkPlus = 139;
flashcardParser.ColonText = 140;
flashcardParser.ColonJson = 141;
flashcardParser.Prosemirror = 142;
flashcardParser.Placeholder = 143;
flashcardParser.BASIC = 144;
flashcardParser.JPG = 145;
flashcardParser.PNG = 146;
flashcardParser.GIF = 147;
flashcardParser.SVG = 148;
flashcardParser.MP2 = 149;
flashcardParser.MP3 = 150;
flashcardParser.MP4 = 151;
flashcardParser.FLV = 152;
flashcardParser.WMV = 153;
flashcardParser.MPEG = 154;
flashcardParser.MPG = 155;
flashcardParser.TEL = 156;
flashcardParser.DotArticleAtt = 157;
flashcardParser.STAR = 158;
flashcardParser.URL = 159;
flashcardParser.LIST_LINE = 160;
flashcardParser.ENCLBARS = 161;
flashcardParser.OpAmpImageWAudio = 162;
...
flashcardParser._serializedATNSegment1 = "\x02\x02\x02\u0119\u0149\x03\x02\x02\x02\u011A\u0118\x03\x02\x02\x02\u011B" +
    ...
    "\x02\u03C8\u03C6\x03\x02\x02";
flashcardParser._serializedATNSegment2 = "\x02\u03C9\u03CA\x05L\'\x02\u03CA\u03CB\x07\x1D\x02\x02\u03CB\u03CC\x05" +
