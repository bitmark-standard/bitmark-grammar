...
choiceParser.OPR = 22;
choiceParser.OPC = 23;
choiceParser.OPITEM = 24;
choiceParser.OPLEAD = 25;
choiceParser.OPPAGENUMBER = 26;
choiceParser.OPMARGINNUMBER = 27;
...
choiceParser.COMMENT = 47;
choiceParser.DCANY = 48;
choiceParser.Image_type = 49;
choiceParser.Audio_type = 50;
choiceParser.Video_type = 51;
choiceParser.ArticleText = 52;
choiceParser.NOTCL = 53;
choiceParser.NUMERIC = 54;
choiceParser.STRING = 55;
choiceParser.NL = 56;
choiceParser.NOTBITMARK = 57;
choiceParser.ELIPSIS = 58;
choiceParser.SENTENCE = 59;
choiceParser.BARSTRING = 60;
choiceParser.OPAT = 61;
choiceParser.AtProgress = 62;
choiceParser.AtReference = 63;
choiceParser.AtWidth = 64;
choiceParser.AtHeight = 65;
choiceParser.AtProgressPoints = 66;
choiceParser.AtShortanswer = 67;
choiceParser.AtLonganswer = 68;
choiceParser.AtExampleWithStr = 69;
choiceParser.AtExamplecol = 70;
choiceParser.AtExamplecl = 71;
choiceParser.AtSampleSolution = 72;
choiceParser.AtPartialAnswerS = 73;
choiceParser.AtPartialAnswer = 74;
choiceParser.AtLabeltrue = 75;
choiceParser.AtLabelfalse = 76;
choiceParser.AtPoints = 77;
choiceParser.AtSrc = 78;
choiceParser.AtPartner = 79;
choiceParser.OPATALT = 80;
choiceParser.OPAMARK = 81;
choiceParser.ShowInIndex = 82;
choiceParser.OpAtCaption = 83;
choiceParser.OpAtLicense = 84;
choiceParser.OpAtCopyright = 85;
choiceParser.OpAtSearch = 86;
choiceParser.OpAtIsTracked = 87;
choiceParser.OpAtIsInfoOnly = 88;
choiceParser.AtDate = 89;
choiceParser.Http = 90;
choiceParser.Https = 91;
choiceParser.AmpAudio = 92;
choiceParser.AmpImage = 93;
choiceParser.AmpImageZoom = 94;
choiceParser.AmpVideo = 95;
choiceParser.AmpArticle = 96;
choiceParser.AmpDocument = 97;
choiceParser.AmpApp = 98;
choiceParser.AmpWebsite = 99;
choiceParser.AmpStillImageFilm = 100;
choiceParser.AmpPdf = 101;
choiceParser.OpAmpAudio = 102;
choiceParser.OpAmpImage = 103;
choiceParser.OpAmpImageZoom = 104;
choiceParser.OpAmpVideo = 105;
choiceParser.OpAmpArticle = 106;
choiceParser.OpAmpArticleAtt = 107;
choiceParser.OpAmpDocument = 108;
choiceParser.OpAmpApp = 109;
choiceParser.OpAmpWebsite = 110;
choiceParser.OpAmpStillImageFilm = 111;
choiceParser.BracEnclose = 112;
choiceParser.AmpAudioLink = 113;
choiceParser.AmpImageLink = 114;
choiceParser.AmpVideoLink = 115;
choiceParser.AmpArticleLink = 116;
choiceParser.AmpDocumentLink = 117;
choiceParser.AmpDocumentDownload = 118;
choiceParser.AmpAppLink = 119;
choiceParser.AmpWebsiteLink = 120;
choiceParser.AmpStillImageFilmLink = 121;
choiceParser.OpAmpAudioLink = 122;
choiceParser.OpAmpImageLink = 123;
choiceParser.OpAmpVideoLink = 124;
choiceParser.OpAmpArticleLink = 125;
choiceParser.OpAmpDocumentLink = 126;
choiceParser.OpAmpDocumentDownload = 127;
choiceParser.OpAmpAppLink = 128;
choiceParser.OpAmpWebsiteLink = 129;
choiceParser.OpAmpStillImageFilmLink = 130;
choiceParser.AmpImageEmbed = 131;
choiceParser.AmpVideoEmbed = 132;
choiceParser.AmpAudioEmbed = 133;
choiceParser.AmpDocumentEmbed = 134;
choiceParser.AmpStillImageFilmEmbed = 135;
choiceParser.OpAmpImageEmbed = 136;
choiceParser.OpAmpVideoEmbed = 137;
choiceParser.OpAmpAudioEmbed = 138;
choiceParser.OpAmpDocumentEmbed = 139;
choiceParser.OpAmpStillImageFilmEmbed = 140;
choiceParser.BitmarkMinus = 141;
choiceParser.BitmarkPlus = 142;
choiceParser.ColonText = 143;
choiceParser.ColonJson = 144;
choiceParser.Prosemirror = 145;
choiceParser.Placeholder = 146;
choiceParser.BASIC = 147;
choiceParser.JPG = 148;
choiceParser.PNG = 149;
choiceParser.GIF = 150;
choiceParser.SVG = 151;
choiceParser.MP2 = 152;
choiceParser.MP3 = 153;
choiceParser.MP4 = 154;
choiceParser.FLV = 155;
choiceParser.WMV = 156;
choiceParser.MPEG = 157;
choiceParser.MPG = 158;
choiceParser.TEL = 159;
choiceParser.DotArticleAtt = 160;
choiceParser.STAR = 161;
choiceParser.URL = 162;
choiceParser.LIST_LINE = 163;
choiceParser.ENCLBARS = 164;
...
choiceParser._serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03\xA6\u0685\x04" +
...
choiceParser._serializedATNSegment1 = "\xFA\xF8\x03\x02\x02\x02\xFB\xF4\x03\x02\x02\x02\xFC\xFF\x03\x02\x02\x02" +
...
choiceParser._serializedATNSegment2 = "\x05\\/\x02\u039F\u03A1\x07g\x02\x02\u03A0\u0397\x03\x02\x02\x02\u03A0" +
...
choiceParser._serializedATNSegment3 = "\x02\x02\u0648\u0649\x03\x02\x02\x02\u0649\u064A\x03\x02\x02\x02\u064A" +
...
class ItemContext extends ParserRuleContext_1.ParserRuleContext {
    OPITEM() { return this.tryGetToken(choiceParser.OPITEM, 0); }
    CL() { return this.getToken(choiceParser.CL, 0); }
    COLON(i) {
        if (i === undefined) {
    ...
    OPC() { return this.tryGetToken(choiceParser.OPC, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
...
class LeadContext extends ParserRuleContext_1.ParserRuleContext {
    OPLEAD() { return this.tryGetToken(choiceParser.OPLEAD, 0); }
    s_and_w(i) {
        if (i === undefined) {
            return this.getRuleContexts(S_and_wContext);
        }
    ...
    OPPAGENUMBER() { return this.tryGetToken(choiceParser.OPPAGENUMBER, 0); }
    OPMARGINNUMBER() { return this.tryGetToken(choiceParser.OPMARGINNUMBER, 0); }
    OPC() { return this.tryGetToken(choiceParser.OPC, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
